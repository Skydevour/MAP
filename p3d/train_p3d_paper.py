...
import cv2
from p3d_paper import Resnet3DBuilder
...
def plot_roc(fpr, tpr, value, fold):
    ...
    plt.savefig("/mnt/hdd/liucheng/gcp3d_ablation/results/roc_auc/{}_{}_roc_curve.png".format(model_name, fold))
...
def build_model(img_size):
    model = Resnet3DBuilder.build_p3d_all(img_size, nb_class)
...
def main():
    ...
    for fold, (train_index, val_index) in enumerate(skf.split(x, y)): # 0 1 2 3 4
        #if fold != 2:
        #    continue
        ...
        model_path = "/mnt/hdd/liucheng/gcp3d_ablation/models/tmp/{}_fold_{}.h5".format(model_name, fold + 1)
        savePath = "/mnt/hdd/liucheng/gcp3d_ablation/results/history/tmp/{}_fold_{}_history.pckl".format(model_name, fold + 1)
