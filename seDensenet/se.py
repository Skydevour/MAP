from keras.layers import GlobalAveragePooling2D, Reshape, Dense, multiply, add, \
                         Permute, Conv2D, AveragePooling2D, Flatten
...
def squeeze_excite_block(input_tensor, ratio=16):
    ...
    se = AveragePooling2D(K.int_shape(init)[1:-1])(init)
